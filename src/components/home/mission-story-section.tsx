    ...
    <div className="flex w-full max-w-[900px] flex-col items-center text-center uppercase">
      <div className="flex flex-col items-center gap-6 md:gap-8">
        <div className="flex flex-col items-center gap-3">
          <p className="type-label-xl font-cormorant-infant text-[#FDF4FF]">OUR MISSION</p>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="type-subtitle-sm md:type-subtitle-md lg:type-subtitle-lg text-[#E2CAF5]">LIFE THROUGH THE GOSPEL</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative flex min-h-0 flex-col items-center px-5 md:px-10 min-[1300px]:hidden">
      ...
      <div className="mt-20 flex h-fit w-full max-w-[760px] flex-col items-center">
        <div className="flex items-center gap-4 uppercase">
          ...
          <p
            className="text-[1.5rem] min-[1300px]:text-[1.875rem] text-[#FDF8FF]"
            style={{
                ...
                >
                  {missionStories.map((story) => (
                    <div
                      ...
                      className="flex h-10 items-center text-[1.5rem] min-[1300px]:text-[1.875rem] text-[#FDF8FF]"
                      style={{
                        fontFamily: "var(--font-cormorant-infant)",
                        fontStyle: "italic",
                        fontWeight: 300,
