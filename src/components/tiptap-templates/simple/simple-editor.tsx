...
function createEditorImageSource(asset: SimpleEditorUploadAsset) {
  const url = new URL(buildUploadPath(asset.storedPath), "http://happyzion.local")
  url.hash = new URLSearchParams({
    happyzionAssetId: String(asset.assetId),
    happyzionStoredPath: asset.storedPath,
  }).toString()
