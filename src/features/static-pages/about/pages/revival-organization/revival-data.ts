...
export const smallGroupCycleSteps = [
  {
    number: "01",
    title: "리더 훈련",
...
export const leaderSelectionCriteria = [
  {
    number: "01",
    title: "영적 성숙도",
    items: [
...
export const smallGroupPrinciples = [
  {
    number: "01",
    title: "말씀 중심 운영",
...
export const personnelTotalCount = 82;
