...
export default function OnlineGivingStaticPage() {
  return (
    <main className="section-shell section-shell--narrow flex flex-col gap-layout-lg bg-white pt-section-sm pb-section-xl md:pt-section-md md:pb-section-xxl lg:pt-section-lg lg:pb-section-3xl">
      ...
      <section className="overflow-hidden border border-[#8b6db5]/18 bg-white">
        <div className="flex flex-col gap-comp-xl px-pad-md py-pad-base md:gap-comp-3xl md:px-pad-xxl md:py-pad-xl">
      ...
      <section className="border border-[#8b6db5]/12 bg-white">
        <div className="flex flex-col gap-comp-4xl px-pad-md py-pad-md md:flex-row md:items-center md:justify-between md:gap-comp-4xl md:px-pad-xxl md:py-pad-base">
          <div className="flex flex-col gap-comp-xl md:flex-row md:items-center md:gap-comp-xl">
            <div className="flex flex-col gap-comp-sm md:gap-comp-xxs shrink-0">
              <p className="type-title-xxs font-semibold uppercase text-[#33103f]">
                Bank Account
              </p>
              <p className="type-body-xs font-bold text-[#33103f] md:font-normal md:text-[#8b6db5]">
                온라인 계좌
              </p>
            </div>
            <div className="hidden h-14 w-px bg-[#8b6db5]/12 md:block" />
            <div className="flex flex-col gap-comp-xxs tracking-[-0.01em] text-[#33103f] md:font-serif md:tracking-[-0.04em]">
              ...
              <p className="type-title-md font-semibold text-[#33103f] md:hidden">
                {givingAccount.accountNumber}
              </p>
              <p className="type-body-xs leading-[1.3] text-[#8b6db5]">
