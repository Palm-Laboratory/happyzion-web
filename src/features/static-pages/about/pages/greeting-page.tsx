...
const ministryPrograms = [
  ...
  },
  {
    ...
    title: "예배사역",
    description:
      "말씀과 기도 중심의 예배, 하나님의 임재를 경험하는 성령충만한 예배 공동체",
  ...
  },
  {
    ...
    title: "미디어 · 문화사역",
    description:
      "찬양팀, 브라스밴드, 디지털 영상, SNS를 통한 복음의 문화적 확산",
  ...
  },
  {
    ...
    title: "기획과 행정",
    description:
      "전문성과 투명성을 갖춘 교회 행정으로 신뢰의 공동체를 세웁니다",
...
function VisionList() {
  return (
    <div className="grid w-full gap-layout-sm">
...
function IntroSection() {
  return (
    <section
      id="greeting"
      className="section-shell section-shell--narrow py-section-sm md:py-section-md lg:py-section-lg"
    >
      <div className="flex flex-col items-start gap-layout-lg lg:gap-layout-xl">
        <SectionHeading
          ...
          <div className="grid w-full min-[660px]:grid-cols-[minmax(0,1fr)_max-content] min-[660px]:items-start min-[660px]:gap-layout-base md:grid-cols-[minmax(0,1fr)_325px] md:gap-layout-md lg:gap-layout-xxl">
            <div className="type-body-sm md:type-body-md flex min-w-0 max-w-[610px] flex-col gap-comp-xl text-[#4A3B5E] lg:gap-comp-3xl">
              <p>
                ...
                치료제를 가지고 죽어가는 영혼을 살리는 일에 목숨을 거는
                교회입니다.
              </p>
              <p>
                한 영혼이 주님께 돌아오는 일, 목마른 영혼에게 복음의 생수를
                나누어 주는 일, 복음이 필요한 곳에 우리를 불러 준다면 최선을
                다해 달려가는 교회입니다.
              </p>
              <p>
                누군가 교회를 향해 교회의 존재이유와 어떤 사역을 하느냐고
                물어본다면 우리는 이렇게 말할 수 있습니다.
              </p>
            </div>
...
function PastorSection() {
  const heading = (
    <SectionHeading
      ...
      className="w-full max-w-none [&>div:first-child_span]:bg-[#c9a96e] [&_h2]:text-white [&_p]:text-[#c9a96e]"
    />
  );

  return (
    <section className="bg-[#1e1035] py-section-sm text-white md:py-section-md lg:py-section-lg">
          ...
          <div className="flex flex-col gap-layout-xl">
            ...
            <div className="type-body-sm md:type-body-md flex flex-col gap-comp-xl text-white/80">
              <p>
                ...
                그 믿음 하나로 1997년 문을 열었습니다.
              </p>
              <p>
                지난 30년, 부흥을 구하며 기도했고, 성령의 일하심을 붙들며 이
                자리까지 걸어왔습니다. 이제 우리의 눈은 다음세대 2040을
                향합니다. 한 사람의 변화가 가정을 살리고, 교회를 깨우고, 이
                세대를 바꿀 수 있기 때문입니다.
              </p>
              <p>
                하나님은 지금 이 순간도 말씀하십니다. &quot;내가 여기
                있나이다&quot; — 라고 응답할 한 사람을 찾고 계십니다. 부흥은
                멀리 있지 않습니다. 당신이 여기 있는 것이, 그 시작입니다.
              </p>
            </div>
          </div>

          <figure className="flex h-full flex-col gap-layout-base justify-self-center text-center min-[660px]:justify-self-end">
            ...
            <figcaption className="flex flex-col gap-comp-xxs">
              ...
              <p className="type-label-xl italic text-[#c9a96e]">
                Senior Pastor
              </p>
            </figcaption>
          </figure>
...
function ElderTeamSection() {
  return (
    <section className="bg-[#3f2551] py-section-sm text-white md:py-section-md lg:py-section-lg">
      <div className="section-shell section-shell--narrow flex flex-col gap-layout-lg min-[551px]:max-[880px]:grid min-[551px]:max-[880px]:grid-cols-[220px_minmax(0,1fr)] min-[551px]:max-[880px]:items-start min-[551px]:max-[880px]:gap-layout-md">
        <div>
          <SectionHeading
        ...
        <div className="grid min-w-0 gap-layout-sm min-[881px]:grid-cols-3">
            ...
            >
              ...
              <div className="flex min-w-0 flex-col gap-comp-md">
                ...
                <div className="flex flex-col gap-comp-sm">
                  <h3 className="type-title-sm leading-tight text-white">
                    {person.name}
                  </h3>
                  <p className="type-caption-md text-white/80">{person.role}</p>
                </div>
              </div>
            </article>
          ))}
...
function MinistryProgramCard({
  ...
  return (
    <article
      className={`border border-[#5d3d8a]/15 bg-white ${
        isStacked
          ? "flex items-start justify-center px-pad-base py-pad-xl md:px-pad-xxl md:py-pad-3xl"
          : "flex items-center px-pad-base py-pad-base md:px-pad-xxl md:py-pad-base"
      } ${className}`}
    >
      <div
        className={
          isStacked
            ? "flex min-w-0 flex-col gap-comp-4xl"
            : "flex min-w-0 gap-comp-xxl"
        }
      >
        <div
          className={
            isStacked
              ? "flex items-center gap-comp-xxl"
        ...
        >
          {isStacked ? (
            <>
              ...
              <div className="flex min-w-0 flex-col gap-comp-sm">
                <p
                ...
                <h3 className="type-title-md leading-tight tracking-[0.01em] text-[#33103f]">
                  {program.title}
                </h3>
              </div>
            </>
        ...
        <div
          className={`min-w-0 ${isStacked ? "" : "flex flex-col gap-comp-base"}`}
        >
          {!isStacked && (
            <div className="flex flex-col gap-comp-sm">
              <p
          ...
          <p className="type-caption-md text-[#6F5576]">
            {program.description}
          </p>
        </div>
      </div>
    ...
    <section className="bg-[#fcf8ff] pt-section-sm pb-section-xl md:pt-section-md md:pb-section-xxl lg:pt-section-lg lg:pb-section-3xl">
      <div className="section-shell section-shell--narrow flex flex-col gap-layout-lg">
        ...
        <div className="flex flex-col gap-layout-xs">
          <div className="hidden gap-layout-xs xl:grid xl:grid-cols-[549fr_649fr] xl:items-end">
            <div className="flex flex-col gap-layout-xs xl:h-[254px]">
              <div className="h-24 bg-[#9A8CA7] xl:h-[108px]" />
              <MinistryProgramCard
                program={ministryPrograms[0]}
                className="min-h-[146px] flex-1"
              />
            </div>
            <div className="grid gap-layout-xs md:grid-cols-2 xl:h-[254px]">
              <MinistryProgramCard
          ...
          <div className="grid gap-layout-xs min-[660px]:max-[767px]:hidden xl:hidden">
            <div className="grid gap-layout-xs md:grid-cols-[minmax(0,1.18fr)_minmax(0,1.82fr)] md:items-stretch">
              <div className="flex flex-col gap-layout-xs">
            ...
            <div className="grid gap-layout-xs md:grid-cols-2 min-[768px]:max-[880px]:hidden">
              <MinistryProgramCard
          ...
          <div className="hidden gap-layout-xs min-[660px]:max-[767px]:grid xl:hidden">
            <div className="h-24 bg-[#9A8CA7]" />
            <div className="grid grid-cols-2 gap-layout-xs">
              <MinistryProgramCard
                program={ministryPrograms[1]}
                className="min-h-[164px] bg-white"
              />
              <MinistryProgramCard
                program={ministryPrograms[0]}
                className="min-h-[164px] bg-white"
            ...
            <div className="grid grid-cols-2 gap-layout-xs">
              <MinistryProgramCard
                program={ministryPrograms[5]}
                className="min-h-[164px] bg-white"
              />
              <MinistryProgramCard
                program={ministryPrograms[6]}
                className="min-h-[164px] bg-white"
              />
            </div>
          ...
          <div className="hidden gap-layout-xs min-[768px]:max-[880px]:grid min-[768px]:max-[880px]:grid-cols-2 xl:hidden">
            <div className="grid gap-layout-xs">
              <MinistryProgramCard
                program={ministryPrograms[3]}
              ...
              <MinistryProgramCard
                program={ministryPrograms[6]}
                className="min-h-[156px] md:py-pad-xl"
              />
            </div>
            <div className="grid gap-layout-xs">
              <MinistryProgramCard
          ...
          <div className="hidden gap-layout-xs xl:grid xl:grid-cols-3">
            <MinistryProgramCard
              program={ministryPrograms[3]}
              className="min-h-[140px]"
            />
          ...
          <div className="grid gap-layout-xs min-[660px]:max-[880px]:hidden md:grid-cols-3 xl:hidden">
            <div className="contents min-[768px]:max-[880px]:grid min-[768px]:max-[880px]:gap-layout-xs">
              <MinistryProgramCard
                program={ministryPrograms[5]}
                className="min-h-[140px]"
              />
          ...
          <div className="hidden gap-layout-xs xl:grid xl:grid-cols-[minmax(0,1fr)_minmax(0,2fr)]">
            <MinistryProgramCard
              program={ministryPrograms[6]}
              className="min-h-[156px] md:py-pad-xl"
            />
